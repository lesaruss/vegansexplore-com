...
// Mirrors the hardcoded `posts` array in pulse.html. These 9 are frozen pre-launch posts
// (June 2026) and do not change, so a one-time copy here is safe. All other Pulse
// articles are live rows in ve_pulse_content, fetched below.
const STATIC_POSTS = [
  {
    slug: 'directory', category: 'Platform',
  ...
  {
    slug: 'guide-tracks', category: 'Guides',
...
module.exports = async (req, res) => {
  ...
  const html = '<!DOCTYPE html>'
    ...
    + '.pulse-detail-wrap{max-width:760px;margin:0 auto;padding:40px 24px 80px;}'
